...
mutual
  gleqd : {e, Ix: _} -> (dr: TaggedDesc e Ix) -> (constraintsr: TaggedConstraints SOrd dr) -> (d: Desc Ix) -> (constraints: Constraints SOrd d) -> {ix: Ix} -> (X, Y: Synthesize d (TaggedData dr) ix) -> Bool
...
mutual
  gleqdAntisymmetricReflexive : {e, Ix: _} -> (dr: TaggedDesc e Ix) -> (constraintsr: TaggedConstraints SOrd dr) -> (d : Desc Ix) -> (constraints: Constraints SOrd d) -> {ix : Ix} -> (X, Y: Synthesize d (TaggedData dr) ix) -> So (gleqd dr constraintsr d constraints X Y) -> So (gleqd dr constraintsr d constraints Y X) -> X = Y
