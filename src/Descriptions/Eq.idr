  ...
  geqReflective d constraints (Con (l1 ** t1 ** r1)) (Con (l2 ** t2 ** r2)) soeq with (decEq l1 l2)
    geqReflective d constraints (Con (l ** t1 ** r1)) (Con (l ** t2 ** r2)) soeq | Yes Refl with (decEq t1 t2)
      geqReflective d constraints (Con (l ** t ** r1)) (Con (l ** t ** r2)) soeq | Yes Refl | Yes Refl with (geqdReflective d constraints (d l t) (constraints l t) r1 r2 soeq)
        geqReflective _ _ (Con (l ** t ** r)) (Con (l ** t ** r)) soeq | Yes Refl | Yes Refl | Refl = Refl
...
mutual
  ...
  geqdReflexive dr constraintsr (Arg _ kdesc) (seqa, seqr) (arg ** rest)  with (choose (arg == arg))
    geqdReflexive dr constraintsr (Arg _ kdesc) (seqa, seqr) (arg ** rest) | Left l with (eqReflective @{seqa} l)
      geqdReflexive dr constraintsr (Arg _ kdesc) (_, seqr) (arg ** rest) | Left _ | Refl = assert_total $ geqdReflexive dr constraintsr (kdesc arg) (seqr arg) rest
