...
mutual
  geqd : {e, Ix: _} -> (dr: TaggedDesc e Ix) -> (constraintsr: TaggedConstraints SEq dr) -> (d: Desc Ix) -> (constraints: Constraints SEq d) -> {ix: Ix} -> (X, Y: Synthesize d (TaggedData dr) ix) -> Bool
...
mutual
  geqdReflective : {e, Ix: _} -> (dr: TaggedDesc e Ix) -> (constraintsr: TaggedConstraints SEq dr) -> (d: Desc Ix) -> (constraints: Constraints SEq d) -> {ix: Ix} -> (X, Y: Synthesize d (TaggedData dr) ix) -> So (geqd dr constraintsr d constraints X Y) -> X = Y
  ...
  geqReflective :  {e, Ix: _} -> (d: TaggedDesc e Ix) -> (constraints: TaggedConstraints SEq d) -> {ix: Ix} -> (X, Y: TaggedData d ix) -> So (geq d constraints X Y) -> X = Y
...
geqSymmetric : {e, Ix: _} -> (d: TaggedDesc e Ix) -> (constraints: TaggedConstraints SEq d) -> {ix: Ix} -> (X, Y: TaggedData d ix) -> So (geq d constraints Y X) -> So (geq d constraints X Y)
...
geqTransitive : {e, Ix: _} -> (d: TaggedDesc e Ix) -> (constraints: TaggedConstraints SEq d) -> {ix: Ix} -> (X, Y: TaggedData d ix) -> (Z: TaggedData d ix) -> So (geq d constraints X Z) -> So (geq d constraints Z Y) -> So (geq d constraints X Y)
